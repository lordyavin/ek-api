...
public abstract class Configuration {
  ...
  private static final String categoriesPath =
      new String(
          new byte[] {
  ...
  public final Try<Document> categoryDocument(
      Category category, int pageNumber, Option<String> searchString) {
    return pageUrl(pageNumber, searchString, Option.of(category))
        .flatMap(url -> Reader.requestDocument(url));
  }

  public final Try<Document> categoryDocument(
      Category category, int pageNumber, String searchString) {
  ...
  public final Try<URL> pageUrl(
      int pageNumber, Option<String> searchString, Option<Category> category) {
    if (pageNumber > pageLimit) {
      logger.info(
          String.format(
              "The requested pageNumber %d is larger than the pageLimit %d. The last possible page"
                  + " will been used.",
