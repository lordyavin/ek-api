...
@Value.Style(
    ...
    /**
     * We use the alternative 'singleton' to be free to use 'of' in our abstract types, because the
     * generated type cannot reduce the visibility of the inherited method from the abstract type.
     */
    instance = "singleton",

    /**
     * Forces extension of abstract value type class in generated signatures instead of the
